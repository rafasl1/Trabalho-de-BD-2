...
function Patrocinadores() {
    ...
    const delPatrocinador = (id) => {
        ...
        if (confirmDelete) {
            axios.get("https://bdbackend.herokuapp.com/removePatrocinador/" + id)
    ...
    const addNovoEventoPatrocinado = async () => {
        ...
        await axios.get("https://bdbackend.herokuapp.com/adicionaPatrocinioPelaEntidade", {
                            ...
                            <div className="formsContainer">
                                ...
                                <div className="itemForms">
                                    ...
                                    <div onChange={(event) => { setNovoEventoPatrocinado([event.target.value]); }}>
                                            {todosOsEventos.map(element => { // eslint-disable-line
